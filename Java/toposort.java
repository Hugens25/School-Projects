...
// Plunk this into Graph.java from last time, and presto-chango: you have the
// ability to topologically sort any arbitrary graph (if a valid topological
// sort for that graph actually exists).
